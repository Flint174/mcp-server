...
Этот проект представляет собой серверную часть на TypeScript, который использует базу данных PostgreSQL и имеет серверный компонент.
...
Примечание: данные в таблице users были добавлены с помощью SQL-команды INSERT.
